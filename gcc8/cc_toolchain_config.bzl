...
def _impl(ctx):
    tool_paths = [
        tool_path(name = "ar", path = "/opt/rh/devtoolset-8/root/usr/bin/ar"),
        tool_path(name = "ld", path = "/opt/rh/devtoolset-8/root/usr/bin/ld"),
        tool_path(name = "cpp", path = "/opt/rh/devtoolset-8/root/usr/bin/cpp"),
        tool_path(name = "gcc", path = "/opt/rh/devtoolset-8/root/usr/bin/gcc"),
        tool_path(name = "dwp", path = "/opt/rh/devtoolset-8/root/usr/bin/dwp"),
        tool_path(name = "gcov", path = "/opt/rh/devtoolset-8/root/usr/bin/gcov"),
        tool_path(name = "nm", path = "/opt/rh/devtoolset-8/root/usr/bin/nm"),
        tool_path(name = "objcopy", path = "/opt/rh/devtoolset-8/root/usr/bin/objcopy"),
        tool_path(name = "objdump", path = "/opt/rh/devtoolset-8/root/usr/bin/objdump"),
        tool_path(name = "strip", path = "/opt/rh/devtoolset-8/root/usr/bin/strip"),
    ]
